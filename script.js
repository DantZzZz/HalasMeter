const APP_CONFIG = {
  ...
  shareUrl: "https://www.stop-cancer.co.il/HalasMeter/",
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "כמו כולם", value: 5 },
        { label: "שששש... נראה לי האיראנים שכחו שהישוב שלי קיים", value: -5 }
      ]
    },
    {
      id: "q3",
      ...
      options: [
        { label: "לממ\"ד", value: 5 },
        { label: "לממ\"ק", value: 10 },
        { label: "למקלט של הבניין", value: 15 },
        { label: "למקלט הציבורי", value: 20 },
        { label: "לגג לצלם ירוטים - כבר יש לי סרטן, מה יש לי להפסיד?", value: 25 }
      ]
    },
    {
      id: "q4",
    ...
    },
    {
      ...
      options: [
        { label: "כן, בפעילות של חלאס", value: 5 },
        { label: "כן, בקבוצת ווטסאפ עם עוד מסורטנים", value: 10 },
        { label: "בסושיאל של חלאס או בקבוצות פייסבוק של חלאס", value: 15 },
        { label: "בשיחה 1:1 עם חבר.ה לסרטן", value: 20 },
        { label: "לא יצא ולא ביצה", value: 30 }
      ]
    }
  ],
  bonuses: [
  ...
  resultBands: [
    { min: 0, max: 25, label: "דובדבן לייט", description: "המלחמה מבאסת, הסרטן מאחוריך. לך.י לעשות פילאטיס." },
    { min: 26, max: 50, label: "דובדבן קטן", description: "את.ה רשמית במועדון. יש לך סיפורים טובים לערב שישי, אבל עוד לא הגעת לשיא." },
    { min: 51, max: 130, label: "דובדבן מקצוען", description: "החיים נתנו לך לימונים, ואז זרקו עליהם רימון. מגיעה לך מדליה או לפחות קינוח עתיר קלוריות." },
    { min: 131, max: 283, label: "דובדבן עם גרורות", description: "רשמית אין אף אחד יותר מסכן ממך בחדר. מותר לך לא לשטוף כלים עד 2028." }
  ]
};
