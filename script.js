const APP_CONFIG = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "במקלט הציבורי", value: 15 },
        { label: "לגג לצלם ירוטים - כבר יש לי סרטן, מה יש לי להפסיד?", value: 20 }
      ]
    },
    {
      id: "q4",
  ...
  resultBands: [
    { min: 0, max: 30, label: "דובדבן לייט", description: "המלחמה מבאסת, הסרטן מאחוריך. לך.י לעשות פילאטיס." },
    { min: 31, max: 50, label: "דובדבן קטן", description: "את.ה רשמית במועדון. יש לך סיפורים טובים לערב שישי, אבל עוד לא הגעת לשיא." },
